"""Deterministic failure classification for managed jobs.
...
Copied verbatim from the (retired) orchestrator so this package depends on
...
def error_hash(log_text: str) -> str:
    """Stable signature for dedup: hash the normalized traceback."""
